      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="row g-4 m-4 p-0 d-flex align-items-stretch g-l">
            ...
            <div class="col-4">
              <label for="formGroupExampleInput2" class="form-label">Journal Status</label>  <h2 class="detailsView"></h2 class="detailsView">
              <input type="text" class="form-control" name="journal_status" value="{{ $item->journal_status}}">
            </div>

            <div class="col-4">
              <label for="formGroupExampleInput2" class="form-label">Journal Description</label>  <h2 class="detailsView"></h2 class="detailsView">
              <input type="text" class="form-control" name="journal_desc" value="{{ $item->journal_desc}}">
            </div>
