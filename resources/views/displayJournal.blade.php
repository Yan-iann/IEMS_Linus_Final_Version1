  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
        ...
        <div class="container-fluid">
          ...
          <div class="col-4">
            ...
            <div class="col-8">
              ...
              <h4 class="detailsView">{{ $item->journal_title}}</h4 class="detailsView">
              </div>
              </div>
            ...
            <div class="row">
              <div class="col-12"><br>
                ...
                <h4 class="detailsView">{{ $item->journal_author}}</h4 class="detailsView">
              </div>
            </div>
          </div>
            ...
            <div class="col-4">
              ...
              <h4 class="detailsView">{{ $item->journal_reference}}</h4 class="detailsView">
            </div>
            ...
            <div class="col-4">
              ...
              <h4 class="detailsView">{{ $item->journal_status}}</h4 class="detailsView">
            </div>

            <div class="col-12">
              <label for="exampleFormControlTextarea1" class="form-label">Description</label>
              <h4 class="detailsView">{{ $item->journal_desc}}</h4 class="detailsView">
            </div>
      ...
      <div class="modal-footer border-0">
        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#ModalEditJournal{{$item->info_ID}}">Edit</button>
